...
<div class="account-form-container">
    <section class="account-form">
        <form action="/brand-demo/loginServlet" method="post">
            ...
            <input type="text" required name="username" value="${cookie.username.value}${username}" maxlength="16"
                   placeholder="enter your account" class="input">
            <input type="password" required name="password" value="${cookie.password.value}" maxlength="30"
